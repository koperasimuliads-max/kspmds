...
export default function LaporanPage() {
  const { anggota, pinjamans, simpanans, transactions, pendapatans, pengeluarans, getLaporanKeuangan, getAnggotaById } = useKSP();
  ...
  return (
    <div>
      ...
      {totalSimpanan === 0 && totalPinjamanAktif === 0 && totalPendapatan === 0 && totalPengeluaran === 0 && (
        <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-lg mb-6">
          <p className="font-medium">Belum ada data laporan!</p>
          <p className="text-sm mt-1">Silakaninput data terlebih dahulu:</p>
          <ul className="list-disc list-inside text-sm mt-2 space-y-1">
            <li>Tambah anggota di menu Anggota (untuk simpanan pokok/wajib)</li>
            <li>Tambah pinjaman di menu Pinjaman</li>
            <li>Tambah pendapatan di menu Pendapatan</li>
            <li>Tambah pengeluaran di menu Pengeluaran</li>
          </ul>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <div className="space-y-2">
            <h3 className="font-medium text-green-700">SIMPANAN ANGGOTA</h3>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <div className="space-y-2">
            ...
            <div className="pl-4 space-y-1 text-sm">
              ...
              <p className="flex justify-between font-medium border-t pt-1"><span>Total Piutang</span><span>{formatRupiah(totalPinjamanAktif)}</span></p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <div className="space-y-2">
            {pendapatans.length === 0 ? (
              <p className="text-sm text-slate-500">Belum ada pendapatan</p>
            ) : (
              <div className="pl-4 space-y-1 text-sm">
                {pendapatans.map(p => (
                ...
                <p className="flex justify-between font-medium border-t pt-1">
